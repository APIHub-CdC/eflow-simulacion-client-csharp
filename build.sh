...
${nuget_cmd} install src/IO.EflowPeruSimulacion/packages.config -o packages;
...
echo "[INFO] Run 'mcs' to build bin/IO.EflowPeruSimulacion.dll"
mcs -langversion:${langversion} -sdk:${sdk} -r:bin/Newtonsoft.Json.dll,bin/JsonSubTypes.dll,\
bin/RestSharp.dll,\
System.ComponentModel.DataAnnotations.dll,\
System.Runtime.Serialization.dll \
-target:library \
-out:bin/IO.EflowPeruSimulacion.dll \
-recurse:'src/IO.EflowPeruSimulacion/*.cs' \
-doc:bin/IO.EflowPeruSimulacion.xml \
-platform:anycpu
...
then
  ...
  echo "[INFO] bin/IO.EflowPeruSimulacion.dll was created successfully"
fi
